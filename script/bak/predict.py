...
fin,fin2=open("../out/train.txt"),open("../out/test.txt")
for line in fin:
    fields=line.split(",")
...
yposition_train, yposition_valid = train_test_split(x, ydegree, ysize, ysalary, yposition, test_size=0.33, random_state=19)
